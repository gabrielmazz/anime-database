...
const TopAnimesScreen: React.FC = () => {
    ...
    // Tradução da sinopse (com alertas de sucesso/aviso/erro como no SearchScreen)
    useEffect(() => {
        let cancelled = false;
        const run = async () => {
        ...
        const observer = new IntersectionObserver((entries) => {
            ...
            const loadMore = async () => {
                try {
                    ...
                    setAlertType('error');
                    setAlertMessage('Falha ao carregar mais animes.');
                    setAlertVisible(true);
                }
                finally {
        ...
        <>
            ...
            <InfoDrawer
                ...
                content={selectedAnime && (
                    <>
                        <Box>
                            <Image src={selectedAnime.images?.jpg?.image_url} radius="md" h={coverHeight} w="auto" className="mb-4
